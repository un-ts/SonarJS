...
const loaders: { [key: string]: Function } = {
  ...
  externalRules(linter: Linter) {
     ...
     */
    const dependencies = [eslintRules, tsEslintRules, react.rules, jsxA11y.rules, import_.rules];
  ...
  pluginRules(linter: Linter) {
    linter.defineRules(sonarjs.rules as unknown as Record<string, Rule.RuleModule>);
  },
  /**
